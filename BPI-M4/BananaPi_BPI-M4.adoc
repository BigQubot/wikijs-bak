...
Banana Pi BPI-M4 use link:{https://drive.google.com/file/d/1Jt8qUwEjLinMqURMftC3db0Xg9MIWIhu/view?usp=sharing}[Realtek RTD1395] chp design ,it is a 64-bit quad-core A53 mini single board computer. It features 1 GB/2GB of RAM and 8 GB eMMC. It also has onboard WiFi for b/g/n/ac and BT 4.2. On the ports side, the BPI-M4 has 4 USB 2.0 ports, 1 USB TYPE C port, 1 HDMI port, 1 audio jack. support M.2 Key E PCIE 2.0 interface.
...
link:{https://wiki.banana-pi.org/Getting_Started_with_M4#Install_Android}[How to install the Android 8.1 image]
...
NOTE: 2020-05-18 update, Kernel 4.9.119
