...
= System Image
== BPI-6204
NOTE: cs6202-ubuntu-mate-20.04.1-desktop-armhf-docker-sd-emmc-20240628.img (The CAN function has not yet been implemented)

Baidu cloud:  https://pan.baidu.com/s/1WII5X_VPzLukxi0eWgbSfg?pwd=8888

Google drive: https://drive.google.com/drive/folders/1WH6GcDuhYPIPJZFPEdH3jJnOHuZqNPpU?usp=sharing

NOTE: cs6202-install-tfcard-20240628.img(The CAN function has not yet been implemented)


Baidu cloud: https://pan.baidu.com/s/19rLPekYLP54TMJzKPuSEgg?pwd=8888 (pincode: 8888)

Google drive: https://drive.google.com/drive/folders/1vJFgNm39SEB0KtAlVYbQA7I-IpO1pIM3?usp=sharing
