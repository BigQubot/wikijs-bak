...
image::/bpi-f4/bpi-f4_jumper1.png[bpi-f4_jumper1.png,width=40%,height=40%]
...
image::/picture/bpi-f4-img_photo.png[bpi-f4-img_photo.png,width=80%,height=80%]
...
image::/bpi-f4/bpi-f4_usbboot.jpg[bpi-f4_usbboot.jpg,width=30%,height=30%]
...
image::/bpi-f4/bpi-f4_emmc_success.png[bpi-f4_emmc_success.png,width=60%,height=60%]
...
image::/bpi-f4/bpi-f4_hdmi.jpg[bpi-f4_hdmi.jpg,width=70%,height=70%]
