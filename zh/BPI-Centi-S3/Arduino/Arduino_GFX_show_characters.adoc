...
这是最基本的套路 Arduino GFX 库，显示 `Hello World!` 屏幕上的字符，并以随机的颜色、坐标和大小显示它们。

> https://github.com/BPI-STEAM/BPI-Centi-S3-Doc/blob/main/arduino_example/01_show_characters_helloworld/HelloWorld.ino[GitHub 源代码]
