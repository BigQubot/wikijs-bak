...
==== 10G SFP WAN
When MT7988A's GPIO3 ouput=High, USXGMII Port1 switches to SFP WAN Port. At this time, SFP is functional, but 10G RJ45 WAN will be ineffective.

==== 10G RJ45 WAN

On the other hand, when MT7988A's GPIO3 ouput=Low, USXGMII Port1 switches to 10G RJ45 WAN Port. At this time, 10G RJ45 WAN is functional, but SFP will be ineffective.
