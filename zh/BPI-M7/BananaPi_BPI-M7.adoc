...
香蕉派BPI-M7采用瑞芯微最新旗舰RK3588八核64位处理器，最高频率为2.4GHz, 6 TOPS NPU，最高内存为32GB。
...
TIP: link:/zh/BPI-M7/GettingStarted_BPI-M7[Getting Started BPI-M7]
...
link:/zh/BPI-M7/Photo_BPI-M7[Banana Pi BPI-M7 Product photo gallery]
...
link:/zh/BPI-M7/display-10-hd[BPI-M7 Display 10 HD]
