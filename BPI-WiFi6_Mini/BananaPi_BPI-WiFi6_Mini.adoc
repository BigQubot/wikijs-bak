...
TIP: link:/en/BPI-WiFi6_Mini/GettingStarted_BPI-WiFi6_Mini[Getting Started BPI-WiFi6_Mini]
...
Old source code: https://github.com/BPI-SINOVOIP/THG6500-TAX2-mini-OPENWRT-BSP +
New source code: https://github.com/BPI-SINOVOIP/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3

WARNING: **Note**: The old source code is incompatible with the new hardware and will cause WiFi malfunctions. +
 +
The new source code is compatible with the old hardware, but its use is not recommended. The new source code requires a MAC address and corresponding key; otherwise, WiFi functionality will be limited, and the device will restart every hour. +
 +
Based on the silkscreen markings on the main chip, the new WiFi chip is vertical, while the old WiFi chip is horizontal.

== Resources

TIP: 	WiFi6mini V10 Schematic

Baidu： https://pan.baidu.com/s/1wMiu6AV0YKWSLZibt9sKqw?pwd=8888 code: 8888

Google: https://drive.google.com/file/d/1o4CZCQh74jp2h5qKiWQJLDi2f5itREyP/view?usp=sharing

TIP: 	WiFi6mini V10 ASSY

Baidu:  https://pan.baidu.com/s/1oMEKqqjDZQoQMYF5H959vg?pwd=8888 code: 8888 

Google: https://drive.google.com/file/d/1xR9kPniIpVnNW6ym5CeFWv08TKUVyRjw/view?usp=sharing
