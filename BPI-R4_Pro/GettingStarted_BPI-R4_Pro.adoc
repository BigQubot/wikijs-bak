...
* Set up the bootstrap switch before supplying power +
  ...
  because NAND has been flashed with image before leaving the factory.） +
* when Connect 12V/5A power adapter to DC-IN connector(CN44),Green LED “PWR” light up， +
  There will be characters similar to the following on the serial terminal +
