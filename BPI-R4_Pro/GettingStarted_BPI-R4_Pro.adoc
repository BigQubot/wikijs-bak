...
=== 3.3V/3.57 Power adjustment
"PCA_A_IO1_0/mPCIe_A_PDN" and "PCA_A_IO0_7/mPCIe_AB_Vset" and "PCA_A_IO1_1/mPCIe_B_PDN"extended from PCA9555 can be turned off and the voltage of PCIe 3.3V can be adjusted. +

[%collapsible]
====
[options="header",cols="1,1,3",width="80%"]
|====
3+| **BPI-R4Pro FAN Connector PIN define**
