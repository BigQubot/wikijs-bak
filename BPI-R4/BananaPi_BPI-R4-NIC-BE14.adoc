...
MediaTek MT7988A (Filogic 880) design: link:/en/BPI-R4/BananaPi_BPI-R4[Banana Pi BPI-R4]  and link:/en/BPI-R4_Pro/BananaPi_BPI-R4_Pro[Banana Pi BPI-R4 Pro] Router development board
...
= Photo
link:/en/BPI-R4/Photo_BPI-R4-NIC-BE14[BananaPi_BPI-R4-NIC-BE14 Photo]
