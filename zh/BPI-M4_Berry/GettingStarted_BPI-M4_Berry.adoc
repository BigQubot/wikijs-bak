...
. link:/en/BPI-M4_Berry/BananaPi_BPI-M4_Berry#_linux[下载最新 Linux 镜像]，并确认 MD5 校验值正确。
...
```
+
(如果使用最小版本镜像，请先参阅 link:/en/BPI-M4_Berry/GettingStarted_BPI-M4_Berry#_install_bananapi_configuration[这里]。)
