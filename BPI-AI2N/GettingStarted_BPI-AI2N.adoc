...
Connecting the Bananapi 7" HC070 touch panel to the carrier board's MIPI DSI interface via an FPC cable. enable panel-hc070iy30025 device-tree overlay.

```sh
overlays=i2c1 spi2 uart0
```

image::/picture/ai2n-dsi-lcd7.png[ai2n-dsi-lcd7.png]
