...
TIP: link:/zh/BPI-AIM7/GettingStarted_BPI-AIM7[BPI-AIM7 快速入门]
...
link:/zh/BPI-AIM7/Photo_BPI-AIM7[Banana Pi BPI-AIM7 产品图集]
...
Google 链接在线查看会缺少文件；请下载并解压文件再查看。核心板和 I/O 底板信息都包含在 hardware.zip 文件中。
