...
and the other two PCIe33.0 1L0 and PCIe33.0 1L1 can be routed to M.2 M-KEY or M.2 B-KEY. +
...
|GPIO |	Output=High	 |Output=Low
|GPIO79/PCIE_1L0_SEL_1p8V		 |PCIE_1L_0 = M.2 M-KEY		|PCIE_1L_0 = M.2 B-KEY
|GPIO63/PCIE_1L1_SEL_1p8V			 |PCIE_1L_1 = M.2 M-KEY		|PCIE_1L_1 = M.2 B-KEY
|====
====
