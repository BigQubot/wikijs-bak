...
== 快速入门
TIP: link:/zh/BPI-CM4/GettingStarted_BPI-CM4[Getting Started BPI-CM4]
...
link:/zh/BPI-CM4/Photo_BPI-CM4[Banana Pi BPI-CM4 Product photo gallery]
...
link:https://docs.banana-pi.org/zh/BPI-CM4IO/BananaPi_BPI-CM4IO[Banana Pi BPI-CM4 IO baord]
