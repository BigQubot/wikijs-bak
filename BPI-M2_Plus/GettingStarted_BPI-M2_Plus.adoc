...
. After you download the image, insert your TF card into your Linux +
Execute "bpi-copy xxx.img /dev/sdx" to install image on your TF card.
 
. After step 3, then you can insert your TF card into M2P, and press power button setup M2P.
