...
TIP: link:/zh/openwrt-one/GettingStarted_openwrt-one[Getting Started OpenWrt One]
...
link:/zh/OpenWRT-One/OpenWRT-One_Photo[OpenWrt One 产品照片]
...
== Debian Linux on Openwrt One

The OpenWrt One is a nice open hardware access point, running OpenWrt by default. As the hardware is reasonably powerful and expandable, running a more general purpose OS like Debian on it can be rather convenient.
...
详细规格请看 : link:/zh/BPI-5400/BananaPi_BPI-5400[BPI-5400B IEEE 802.3at 30W POE PD PoE module]
