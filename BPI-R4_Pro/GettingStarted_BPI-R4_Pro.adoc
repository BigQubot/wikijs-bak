...
Before flashing image into Nand, please prepare a USB disk. Let's take OpenWrt image (**BPI-R4Pro-8X-BE14-MT76-OpenWRT24.10-DSA-snand-factory-251120.bin**) for example, the steps are below:

. Format the USB disk to FAT32.
. Copy Nand boot OpenWrt image(**BPI-R4Pro-8X-BE14-MT76-OpenWRT24.10-DSA-snand-factory-251120.bin**) to USB disk. 
...
mtd write mtk-bpi-r4pro-NAND-20250928.img /dev/mtd3
