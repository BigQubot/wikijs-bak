...
==== Install Image with dd command
> Suport Linux. 

Umount SDcard device /dev/sdX partition if mounted automatically. Actually bpi-copy is the same as this dd command.
+
```bash
