...
TIP: 更多信息：link:/en/BPI-F3/BananaPi_BPI-F3[Banana Pi BPI-F3 主页]

= 开发
== 准备
. 准备一根 TTL 串口线、一个 12 V PD 电源、一根 USB 数据线，以及一张至少 8 GB 的 TF 卡。
. 请 link:/en/BPI-F3/BananaPi_BPI-F3#_system_image[下载] 待烧录的 SD 卡镜像和 eMMC 镜像。
...
. link:/en/BPI-F3/BananaPi_BPI-F3#_tools[下载 Titan Flasher]
