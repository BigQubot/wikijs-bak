...
Banana Pi BPI-R4 Lite smart router board design with MediaTek MT7987A Quad-core Arm Cortex-A53,it support 2GB DDR4 and 8G eMMC Flash on board. 1 2.5G SFP LAN and 1 2.5G RJ45 WAN , support 4 x 1G RJ45 LAN port. support M.2 for 4G/5G module.1x miniPCIe slot with PCIe3.0 2lane interface for Wi-Fi 7 NIC.   
...
== 4G/5G module
link:/en/BPI-R4_Lite/GettingStarted_BPI-R4_Lite#_4G_5G_module[GettingStarted_BPI-R4_Lite#4G/5G Module]

== Heat sink

=== R4 Lite heatsink

image::/bpi-r4_lite/banana_pi_bpi-r4_lite_heatsink1.jpg[banana_pi_bpi-r4_lite_heatsink1.jpg,width=60%]

Easy to buy R4 Lite heatsink sample ::

* BANANAPI Official Shop: https://www.bpi-shop.com/products/bpi-r4-lite-aluminum-heatsink.html

* Taobao shop: https://item.taobao.com/item.htm?ft=t&id=997972969570

=== BE14 heatsink

image::/bpi-r4_lite/banana_pi_bpi-r4_lite_heatsink2.jpg[banana_pi_bpi-r4_lite_heatsink2.jpg,width=50%]
...
image::/bpi-r4_lite/be14散热片.png[be14散热片.png]

* SINOVOIP: https://www.aliexpress.com/item/1005010661287648.html

* bpai: https://pl.aliexpress.com/item/1005010661345515.html?gatewayAdapt=glo2pol
...
link:https://docs.banana-pi.org/en/BPI-R4/GettingStarted_BPI-R4#_wi_fi7_nic[Getting_Started_with_BPI-R4_Lite#Wi-Fi7 NIC]
...
* Source code on github: https://github.com/BPI-SINOVOIP/BPI-R4Lite-OPENWRT-V24.10.0-Master-Devel
...
= System Image
== OpenWrt-21.02
=== OpenWRT-21.02 MTK wifi driver MP4.2 wifi SDK wifi driver for BE14000 Wifi Card(1 PCIE,2 Lane）
Baidu: https://pan.baidu.com/s/1VU72GxDFtYykZIPE6ll9jQ (pin code: 8888) 

Google drive: https://drive.google.com/file/d/1XQrU_f9fsoEvoHx7DnhTFvVsK3MdYsIl/view?usp=sharing

**NOTE**

1. Kernel version: 5.4
2. Build environment: Ubuntu 18.04
3. MTK vendor’s MP4.2 wifi image package name: BPI-R4Lite-BE13500-WIFI_OpenWRT-21.02-MP4_2-SDK-V10-1PCIe-2L-20251009.zip
...
=== OpenWRT-21.02 MTK MP4.2 wifi SDK wifi driver (2 PCIE ，both have 1 Lane）
Baidu cloud:
Baidu : https://pan.baidu.com/s/1cz1lZi-HSt6VgJiT9IX9TQ (pin code: 8888）

Google drive: https://drive.google.com/file/d/1DSqLGWKKbI7XcJkKpdTvv-TM-WexKSIR/view?usp=sharing

**NOTE**

1. Kernel version: 5.4
2. Build environment: Ubuntu 18.04
3. MTK vendor’s MP4.2 wifi image package name: BPI-R4Lite-BE13500-WIFI_OpenWRT-21.02-MP4_2-SDK-V10-2PCIe-1L-20251009.zip
4. MTK vendor’s MP4.2 wifi driver sourcecode can’t be open source. only release Image.(support Quectel RM500U-CN & RM520N-GL 5G Modules, EC25 EM05 4G Modules)

== OpenWrt-24.10
=== OpenWRT-24.10 MT76 OpenSource wifi driver  wifi SDK  for BE14000 Wifi Card(1 PCIE,2 Lane）
Baidu cloud:
https://pan.baidu.com/s/1fiBy0946yQeiMTuxIVakMQ (pin code: 8888)

Google drive:
https://drive.google.com/file/d/1JDeNhMk9WbpyL6wJJOQV8Xd5T8exRuO6/view?usp=sharing

**NOTE**

1. Kernel version: 6.6
2. Build environment: Ubuntu 20.04
3. image package name: BPI-R4Lite-BE13500-WIFI_OpenWRT-24.10-SDK-V10-1PCIe-2L-20250928

=== OpenWRT-24.10 MT76 OpenSource wifi driver  wifi SDK (2 PCIE ，both have 1 Lane）
Baidu cloud: https://pan.baidu.com/s/1Fctq6HRMy4SOrQFcZ1ym7A (pincode: 8888)

Google drive: 
https://drive.google.com/file/d/1oHcgG_X0_0tvaNZximIQj8VcgghKmQzh/view?usp=sharing

**NOTE**

1. Kernel version: 6.6
2. Build environment: Ubuntu 20.04
3. image package name: BPI-R4Lite-BE13500-WIFI_OpenWRT-24.10-SDK-V10-2PCIe-1L-20250928
