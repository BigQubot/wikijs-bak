...
Features Map: http://newwiki.banana-pi.org/en/BPI-M2_Ultra_Berry/M2U-Berry_Image_Map#_ubuntu_16_04
...
Features Map: http://newwiki.banana-pi.org/en/BPI-M2_Ultra_Berry/M2U-Berry_Image_Map#_debian_9
