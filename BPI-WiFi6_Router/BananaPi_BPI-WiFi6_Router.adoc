...
Old source code: https://github.com/BPI-SINOVOIP/THG6500-TAX2-OPENWRT-BSP +
New source code: https://github.com/BPI-SINOVOIP/THG6500-TAX2-OPENWRT-BSP_TGP3
...
TIP: BPI-WiFi6 Schematic

Baidu cloud: https://pan.baidu.com/s/16c8t09cWXovTMgPh2XYeKg?pwd=8888 (pincode: 8888)

Google drive: 
https://drive.google.com/file/d/1ACCs0LddjU0Za6j25xwjp2C_CsRR9AMN/view?usp=sharing


TIP: Banana Pi BPI wifi6 router with Triductor TR6560 + TR5220 wifi SOC test PoE and OpenWRT: https://www.youtube.com/watch?v=Nf03ssN8ez0
