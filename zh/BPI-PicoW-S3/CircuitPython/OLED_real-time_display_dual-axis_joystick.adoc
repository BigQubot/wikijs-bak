...
link:/en/BPI-PicoW-S3/CircuitPython/ADC_input[ADC 输入，使用双轴操纵杆]

link:/en/BPI-PicoW-S3/CircuitPython/Download_and_install_the_CircuitPython_library[下载并安装 CircuitPython 驱动SSD1306的库 oled 显示模块]

可以设计一个程序来使 OLED 实时动画显示双轴摇杆位置。

**接线参考**
[cols="^,^",options="header",]
|===
|固态硬盘1306 |BPI-PicoW-S3
|接地 |接地
|电压控制电路 |3V3
|SCL |GP0
|SDA |GP1
