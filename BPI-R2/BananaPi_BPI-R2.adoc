...
link:http://fw-web.de/dokuwiki/doku.php?id=en:bpi-r2:start[Getting Start with Frank Wiki]
...
link:https://newwiki.banana-pi.org/en/BPI-MT7615_802_11_ac_wifi_4x4_dual-band_module[BPI-MT7615 802.11 ac wifi 4x4 dual-band module]

link:https://newwiki.banana-pi.org/en/BPI-R64_%2B_MT7615_function_test[BPI-R64 + MT7615 function test]
