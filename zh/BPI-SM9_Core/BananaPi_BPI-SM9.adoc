...
TIP: link:/zh/BPI-SM9/GettingStarted_BPI-SM9[Getting Started BPI-SM9]
...
link:/zh/BPI-sm9/Photo_BPI-sm9[Banana Pi BPI-SM9 产品图片]
...
|操作系统 | ubuntu22.04或Linux5.10+QT5.15
