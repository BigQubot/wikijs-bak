...
TIP: Linux Armbian build source code https://github.com/BPI-SINOVOIP/armbian-build/tree/bpi-v24.11.01

TIP: Linux 5.4 boot pack source code https://github.com/Dangku/allwinner-boot-pack

TIP: Linux 5.4 uboot source code https://github.com/BPI-SINOVOIP/pi-u-boot/tree/sun50iw9-v2018.05

TIP: Linux 5.4 kernel source code https://github.com/BPI-SINOVOIP/pi-linux/tree/sun50iw9-5.4
