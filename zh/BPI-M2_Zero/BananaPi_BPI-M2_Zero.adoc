...
TIP: link:/zh/BPI-M2_Zero/GettingStarted_BPI-M2_Zero[Getting Started BPI-M2_Zero]
...
link:/zh/BPI-M2_Zero/Photo_BPI-M2_Zero[Banana Pi BPI-M2 Zero Product photo gallery]
...
Features Map: http://docs.banana-pi.org/zh/BPI-M2_Zero/M2Z_Image_Map#_内核_3_4
