...
Fetures Map: https://wiki.banana-pi.org/en/BPI-M4/M4_Image_Map#_debian_10_buster
...
Fetures Map: https://newwiki.banana-pi.org/en/BPI-M4/M4_Image_Map#_raspbian_9.8_stretch
