...
```
Configure overlays with armbian-config, System->Kernel->DTO, more info of armbian-config, please ref to link:https://docs.armbian.com/User-Guide_Armbian-Config[Armbian-Config Guide]

image::/picture/ai2n_overlay.png[ai2n_overlay.png]

Another way, add names of overlays you want to activate to overlays= line in /boot/armbianEnv.txt, separated with spaces, for example, enable i2c2, spi2 and uart0 overlays
