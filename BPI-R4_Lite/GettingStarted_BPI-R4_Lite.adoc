...
SW3A and SW3B control the signal originating from the chip MT7987:
...
When SW3_C is 1, the switch physically connects to SD.
When SW3_C is 0, the switch physically connects to EMMC.
