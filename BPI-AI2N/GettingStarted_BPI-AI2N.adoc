...
The SPI bootloader consists of three parts: the Flash Writer file, ATF firmware, and U-Boot. There are three files: Flash_Writer*.mot, bl2_bp_spi.srec, and fip.srec, which can be found in the /boot directory of the Linux image.
