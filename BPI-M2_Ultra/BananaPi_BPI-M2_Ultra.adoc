...
Features Map: http://docs.banana-pi.org/en/BPI-M2_Ultra_Berry/M2U-Berry_Image_Map#_android_6_0_1_hdmi__26_lcd7
...
BPI-M2U Debian 9 Features Map: http://docs.banana-pi.org/en/BPI-M2_Ultra_Berry/M2U-Berry_Image_Map#_debian_9
...
BPI-M2U Raspbian 9 Features Map: http://docs.banana-pi.org/en/BPI-M2_Ultra_Berry/M2U-Berry_Image_Map#_raspbian_9_4
...
More please see : link:https://docs.banana-pi.org/en/Tina_Linux[Tina Linux]
