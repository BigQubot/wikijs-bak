...
| **Underlying system** | OpenWrt v25.12.5（Linux Kernel 6.12）
...
|**BPI-R4 Pro (4E)** | MediaTek MT7988A | 4GB RAM, 4×2.5G + 10G WAN, system status LEDs 
...
image::/bpi_os_en/4.1_dashboard.png[4.1_dashboard.png]

==  4.2 Network & Wireless

- **WAN**: DHCP / static IP / PPPoE, dual-stack IPv4 + IPv6.

image::/bpi_os_en/4.2.1_network.png[4.2.1_network.png]
...
image::/bpi_os_en/4.2.2_device.png[4.2.2_device.png]
...
image::/bpi_os_en/4.3_vpn.png[4.3_vpn.png]
- **Port forwarding**: map external ports to internal devices.

image::/bpi_os_en/4.3_port.png[4.3_port.png]
- **DMZ**: forward all inbound WAN traffic to a single internal host.

image::/bpi_os_en/4.3_dmz.png[4.3_dmz.png]
- **Firewall rules**: custom accept / reject / drop rules.

image::/bpi_os_en/4.3.2_firewall.png[4.3.2_firewall.png]
- **DDNS**: bind a dynamic public IP to a fixed domain (DuckDNS / No-IP / Dynu / Cloudflare / FreeDNS).

image::/bpi_os_en/4.3_ddns.png[4.3_ddns.png]
==  4.4 System management

image::/bpi_os_en/4.4.1_normal_password.png[4.4.1_normal_password.png]
image::/bpi_os_en/4.4.2_firmware_backup_security.png[4.4.2_firmware_backup_security.png]
...
image::/bpi_os_en/4.5.1_user.png[4.5.1_user.png]
...
image::/bpi_os_en/4.5.2_audit.png[4.5.2_audit.png]
---
...
image::/bpi_os_en/7.1_login.png[7.1_login.png]
- **Dark mode**: light / dark.

image::/bpi_os_en/7.2_dark.png[7.2_dark.png]
...
BpiRouterOS source code: https://github.com/BPI-SINOVOIP/bpirouteros/releases
