...
The Android and Linux images of R2 Pro have the same burning method on Windows.link:/en/BPI-R2_Pro/GettingStarted_BPI-R2_Pro#_install_image_with_usb_download_tool[Install Image with Usb Download Tool-Windows]
