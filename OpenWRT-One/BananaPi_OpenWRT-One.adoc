...
TIP: link:/en/openwrt-one/GettingStarted_openwrt-one[Getting Started OpenWrt One]
...
TIP: The default NAND image for the board: OpenWrt 24.10.0 rc2. You can find the corresponding version on the official website of OpenWrt.
...
link:https://www.bpi-shop.com/products/banana-pi-openwrt-one-router.html[BANANAPI Official shop] 
