...
[%collapsible]
====
[options="header",cols="1,4",width="90%"]
|=====
|SOC	|SF19A2890架构，双核1GHz,3200dmips
|FLASH|	8MB/64 DDR2
|天线(外置)	|2.4G:2T2R 5dBm 5.8G:2T2R 5dBm
|端口	|4×10/100/1000Mbps RJ45(WAN×1+LAN×3)
|按钮	|WPS/RESET
|供电方式	|DC 12V/1A
|LED灯	|WiFi、WPS
|无线频率范围	|2.4~2.4835GHz、5.150GHz～5.850GHz
.2+|无线速率	|11b:1/215.5111Mbps                   11n:up to 300Mbps
|11g:6/9/12/18/24/36/48154Mbps       11ac:up to 866Mbps
.2+|工作频段	|2.4G:1~13
|5.8G:36,40,44,48,52,56,60,64,149,153,157,161,165
|扩频技术	|DSSS (Direct Sequence Spread Spectrum)
.5+|数据调试方法	|802.11a:OFDM(BPSK,QPSK,16-QAM,64-QAM)
|	802.11b:DSSS  (DQPSK,DBPSK,CCK)
|	802.11g:OFDM  (BPSK,QPSK,16-QAM,64-QAM)
|802.11n:OFDM  (BPSK,QPSK,16-QAM,64-QAM)
|	802.11ac:OFDM(BPSK,QPSK,16-QAM,64-QAM,256-QAM)
|介质访问协议|	WPA-PSKWPA2-PSK、WPAWPA2


.4+|TX Power/EVM	 |                
	            .3+| 2.4G   |802.11a/b/g 1Mbps 
                          |802.11a/b/g 54Mbps
		                      |802.11n20 MCS0    
