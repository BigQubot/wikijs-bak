...
=== USB2.0 connector
The power output of the USB3.2 connector (CN12) is 5V/1300mA, which can be turned off via "PCA_A_IO1_3/VBUS_AB_PDN" output low. +
...
These two FAN interfaces are controlled by the same PWM (GPIO57_PWMD0). +
