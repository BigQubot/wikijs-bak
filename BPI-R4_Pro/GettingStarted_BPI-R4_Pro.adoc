...
However, the eSIM does not have components. If you need it, please contact our sales. +

image::/bpi-r4_pro/bpi-r4_pro/b-key-sim.png[b-key-sim.png,width=300]

image::/bpi-r4_pro/bpi-r4pro-sim.png[bpi-r4pro-sim.png,width=300]
...
This allows you to easily design a SIM card adapter board to fit your enclosure.

==== eSIM
PIN42/44/46/48 of M.2 B-KEY Slot is the second set of SIM card signals. +
Of course, this requires your module to support it. +
 +
