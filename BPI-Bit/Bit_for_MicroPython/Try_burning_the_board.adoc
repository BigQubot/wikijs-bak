...
Now that the burn is complete, you can move on to the next chapter link:/en/BPI-Bit/Bit_for_MicroPython/Hello,_World[4 Hello, World!]，If you have any other questions or want to know more, please read on.
