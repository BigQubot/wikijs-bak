...
BPI-3588-LGA核心板采用瑞芯微RK3588旗舰芯片，集成6Tops NPU和高性能四核Mali-G610 MP4 GPU。采用LGA 506pin封装方式，可扩展多种显示接口和工业应用接口。使用开放的基板设计材料和开源sdk，可以有效地开发它。它支持多种操作系统，如Android、Ubuntu、Debian和builroot。为各种AI应用场景提供鲁棒、稳定、可靠、可扩展的产品支持，广泛适用于边缘计算等领域
