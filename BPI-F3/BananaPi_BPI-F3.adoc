...
== POE support
We design PoE function for BPI-R64 ,so easy to add PoE module to support PoE function.After welding the POE module, it is powered by the RJ45-2 interface.
...
TIP: https://github.com/BPI-SINOVOIP/pi-opensbi/tree/v1.3-k1

TIP: u-booy: https://github.com/BPI-SINOVOIP/pi-u-boot/tree/v2022.10-k1

TIP: https://github.com/BPI-SINOVOIP/pi-linux/tree/linux-6.1.15-k1
...
=== Official image
NOTE: 2024-4-30 release,bianbu 23.10 image

Google Drive: https://drive.google.com/drive/folders/1H9sx6_5dUsZfkoZk0hY-4KWto2hpUrme

Baidu Cloud: https://pan.baidu.com/s/14I8K7Mj90z5R4Rsset0mEw?pwd=8888 pincode:8888
