...
- The following example code reads the state of a button connected to physical pin.3, and lights an LED connected to physical pin.31 when the button is pressed:
+
```sh
 import gpiod
