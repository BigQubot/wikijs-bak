...
== SD card burn image
NOTE: Please pay attention to whether the TF card clips on the board are correctly positioned. please see: link:link:/en/BPI-SM9/GettingStarted_BPI-SM9#TF_card_detection_and_GPIO_selection[TF card detection and GPIO selection]
