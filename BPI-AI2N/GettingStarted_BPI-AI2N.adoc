...
The RZ/V2N chip features a single MIPI DSI interface for display output. We have developed a DSI-to-HDMI adapter board and a 7-inch HC070 Touch Panel board. 
...
== ADC
There have 3 units 12-bit adc in RZV2N, up to 8 channels per unit. The board adc pin header CN3 connected to adc1.
