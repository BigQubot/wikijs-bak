...
link:/en/BPI-PicoW-S3/CircuitPython/ADC_input[ADC 输入：使用双轴摇杆]

link:/en/BPI-PicoW-S3/CircuitPython/Download_and_install_the_CircuitPython_library[下载并安装用于驱动 SSD1306 OLED 显示模块的 CircuitPython 库]
