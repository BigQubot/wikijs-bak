...
> __Due to the compatibility of the BPI-R4 with Qualcomm/Unisoc modules, the EC25 module cannot directly access the DNS server and connect to the internet due to software differences. Therefore, manual configuration is required to modify the default.script file via serial port.__
...
IMPORTANT:  The 12V power supply will be supplied to the BPI-R4-NIC through PIN6/8/48 of the miniPCI socket. 
