...
Or you can also insert a 10G XGSPON Stick to access the operator's network. +
 +
```bash

root@R4Pro-01i-NAND:~# [   84.886999] sfp sfp2: SM: enter empty:down:down event insert
