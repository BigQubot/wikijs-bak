...
TIP: 晶晨(Amlogic) A311D 设计 : link:/en/BPI-M2_Super/BananaPi_BPI-M2_Super[Banana Pi BPI-M2S] 单片机 +
晶晨(Amlogic) A311D 设计 : link:/en/BPI-CM4/BananaPi_BPI-CM4[Banana Pi BPI-CM4] 计算机模块
