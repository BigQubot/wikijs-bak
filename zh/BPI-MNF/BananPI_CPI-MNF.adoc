...
这是一款基于 link:/zh/BPI-R64/BananaPi_BPI-R64[香蕉派 BPI—R64]设计的 link:/en/BPI_4.0_Server[BPI 4.0服务器]，采用MTK7622四核64位A53芯片设计，主频高达1.35g。板载1—2g DDR内存和8g eMMC存储。可支持OpenWRT、Linux操作系统、深度定制的小草科技综合通信软件平台。提供完整的融合通信、多链路通信解决方案。并支持物联网扩展。免费接入物联网应用。
