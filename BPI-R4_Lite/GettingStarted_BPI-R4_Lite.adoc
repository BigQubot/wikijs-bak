...
For the image mtk-bpi-r4lite-SD-NAND-MP4_2-2PCIe-1L.img: Bootstrap loads from NAND and this image is programmed into the SD Card. The jumper settings should be 1000.

For the image mtk-bpi-r4lite-SD-NOR-MP4_2-2PCIe-1L.img: Bootstrap loads from NOR, and this image is programmed into the SD Card. The jumper settings should be 1001.
