...
(For those who use the minimal version of the image, please take a look link:/en/BPI-M4_Berry/GettingStarted_BPI-M4_Berry/install_bananapi-configuration[here first].)
...
[options="header"]
|=====
2+|Bananapi M4 Berry Tested HDMI LCD
|Panel	                      |Test Video
