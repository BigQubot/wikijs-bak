...
| SDRAM            | 8GB DDR4
| On board Storage | MicroSD (TF) card + 
                     8GB eMMC flash + 
                     256MB SPI-NAND Flash + 
...
| SFP              |1x 10G SFP+ WAN + 
                    1x 10G SFP+ LAN + 
| mini PCIE  Slots | 2x miniPCIe slots with PCIe3.0 2lane interface for Wi-Fi NIC
| M.2 Slots        | 2x M.2 M-KEY slots with PCIe3.0 1lane interface for NVME SSD +  
