...
香蕉派BPI-CM6是一款工业级RISC-V核心板，它采用SpacemiT K1 8核RISC-V芯片设计，CPU集成2.0 TOPs AI计算能力。4/8/16G DDR和8/16/32/128G eMMC。设计了板对板连接器，以增强稳定性，与树莓派CM4尺寸相同，并兼容Raspberry Pi CM4底板。
...
link:/zh/BPI-F3/SpacemiT_K1_datasheet[进迭时空（SpacemiT）K1 8 核 RISC-V 芯片规格] +
...
* 4GB LPDDR4内存(支持可选,4,8,16GB)
* 16GB eMMC存储
* 1x SDIO RTL8852BS Wifi6 /BT5.2模块
...
TIP: link:/zh/BPI-CM6/GettingStarted_BPI-CM6[BPI-CM6 快速上手]
...
TIP: Banana Pi BPI-CM6 deepseek demo https://docs.banana-pi.org/zh/BPI-CM6/BananaPi_BPI-CM6 
...
* Banana Pi 官方店铺: https://www.bpi-shop.com/products/banana-pi-bpi-cm6-spacemit-k1-8-core-risc-v.html

* 淘宝官方店铺: https://item.taobao.com/item.htm?ft=t&id=997097158741
