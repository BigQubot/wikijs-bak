...
+
从 Git 仓库安装库。该仓库派生自 link:https://github.com/adafruit/Adafruit_CircuitPython_SSD1306[Adafruit_CircuitPython_SSD1306]，库和示例已按 link:https://docs.banana-pi.org/zh/BPI-OLED/BananaPi_BPI-OLED[SSD1306 SPI OLED 模块]的硬件进行修改。
+
```sh
...
- lcd-adafruit：link:https://docs.banana-pi.org/zh/BPI-LCD_1602/BananaPi_BPI-LCD_1602[BPI LCD 1602 显示模块]
- oled：link:https://docs.banana-pi.org/zh/BPI-OLED/BananaPi_BPI-OLED[BPI OLED 显示模块]
- ssd1306/oled: link:https://makershop.ie/SSD1306-0.96-OLED-Display[0.96" I2C SSD1306 OLED]
- matrixled：link:https://docs.banana-pi.org/zh/BPI-RGB_LED/BananaPi_BPI_RGB_LED[BPI RGB LED 矩阵扩展模块]
- berryclip：link:https://docs.banana-pi.org/zh/BPI-BerrClip/BananaPi_BPI-BerryClip[BPI BerryClip 模块]
