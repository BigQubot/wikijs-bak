...
Banana Pi BPI-R4Pro Router board with MediaTek MT7988A(Filogic 880) quad-core ARM Corex-A73 design ,4GB/8GB DDR4 RAM,8GB eMMC,256MB SPI-NAND flash onboard.It supports 4 x 2.5G network ports and 2 x 10G photoelectric ports, support 4G/5G expansion。it is a update version for BPI-R4.
