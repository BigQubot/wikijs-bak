...
. link:/en/BPI-R4/BananaPi_BPI-R4_FAQ#_determine_the_size_of_the_ddr_memory[Determine the size of the ddr memory]
...
. link:/en/BPI-R4/BananaPi_BPI-R4_FAQ#_restore_factory_settings_on_openwrt[Restore_factory_settings_on_openwrt]
. link:/en/BPI-R4/BananaPi_BPI-R4_FAQ#_openwrt_mainline_image_txpower_low[Openwrt mainline image txpower low]
...
== Determine the size of the DDR memory
...
. If the first three steps fail to start BE14, you can try re- burning the link:/en/BPI-R4/BananaPi_BPI-R4#_system_image[image].
...
== Restore factory settings on OpenWrt
. click "perform reset" on the web page.
