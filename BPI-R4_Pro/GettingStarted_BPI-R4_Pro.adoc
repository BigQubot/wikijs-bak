...
NOTE: Our default image configuration: After inserting the SFP module, USXGMII will automatically switch to 10G SFP+, and 10G RJ45 will not be usable；  +
**Therefore, if you want to use 10G RJ45, do NOT insert the module on SFP+. **
...
We connected SIM1 to the onboard NANO SIM Slot and SIM2 to the eSIM. +
However, the eSIM does not have components. If you need it, please contact our sales. +

image::/bpi-r4_pro/bpi-r4pro-sim.png[bpi-r4pro-sim.png,width=500]
