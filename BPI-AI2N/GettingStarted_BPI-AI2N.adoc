...
more info of overlays configurtion using armbian-config, please ref to link:https://docs.armbian.com/User-Guide_Armbian-Config/System/#device-tree-overlays[Armbian-Config Device Tree Overlays]
...
You can use armbian-config to manage SSH daemon options

image::/picture/ai2n-armbian-config-ssh.png[ai2n-armbian-config-ssh.png]

more info of SSH configuration using armbian-config, please ref to link:https://docs.armbian.com/User-Guide_Armbian-Config/System/#ssh-daemon[Armbian-Config SSH daemon]
