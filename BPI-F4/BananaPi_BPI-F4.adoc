...
PS: The cable must be 0.5 mm² (AWG20).

Also, do not connect the positive and negative terminals incorrectly.

Do not power the board together with the DC power socket.
