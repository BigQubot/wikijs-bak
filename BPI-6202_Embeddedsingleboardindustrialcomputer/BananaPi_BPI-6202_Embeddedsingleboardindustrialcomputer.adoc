...
* link:/en/BPI-6202_Embeddedsingleboardindustrialcomputer/GettingStarted_BPI-6202[Getting Started BPI-6202]
...
image::/indu-board/industrial_computer_en_6.png[industrial_computer_en_6.png]
