...
TIP: GitHub 上的源代码： +
旧源代码： https://github.com/BPI-SINOVOIP/THG6500-TAX2-mini-OPENWRT-BSP +
新源代码： https://github.com/BPI-SINOVOIP/THG6500-MINI-TAX2-OPENWRT-BSP_TGP3

WARNING: 注意：旧源代码与新硬件不兼容，会导致 WiFi 故障。 +
新源代码与旧硬件兼容，但不建议使用。新源代码需要 MAC 地址和对应的密钥；否则，WiFi 功能将受到限制，并且设备会每小时重启一次。 +
以主芯片上的丝印为基准，新的WiFi芯片是垂直的，而旧的WiFi芯片是平行的。
