...
IMPORTANT:  The 12V power supply will be supplied to the BPI-R4-NIC through PIN6/8/48 of the miniPCI socket. When plugging in other modules, be sure to turn off SW4 if you cannot confirm whether the module can withstand 12V.
