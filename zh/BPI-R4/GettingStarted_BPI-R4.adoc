...
* link:https://docs.banana-pi.org/en/BPI-R4/BananaPi_BPI-R4#_system_image[下载]待烧录的镜像
...
== 如何将镜像烧录到 SD 卡
IMPORTANT: 使用 Ubuntu 或 Debian 6.1 内核的 SD 卡镜像启动后，NAND 中的镜像将无法启动，link:/en/BPI-R4/GettingStarted_BPI-R4#_how_to_burn_image_to_onboard_nand[需要重新烧录]。
...
link:/en/BPI-R4/BananaPi_BPI-R4-NIC-BE14[Banana Pi BPI-R4-NIC-BE14 规格]
