...
TIP: link:/zh/BPI-R4/GettingStarted_BPI-R4[Getting Started BPI-R4]
...
link:/zh/BPI-R4/Photo_BPI-R4[Banana Pi BPI-R4 产品图片]
...
| 尺寸           | 100.5x148mm same as link:/zh/BPI-R64/BananaPi_BPI-R64[Banana Pi BPI-R64] and link:/zh/BPI-R2/BananaPi_BPI-R2[Banana Pi BPI-R2]
| 重量           | 250g 
|====
...
TIP: BPI-R4 配件组装: https://docs.banana-pi.org/zh/BPI-R4/BPI-R4_Accessory_installation
...
Google Drive: https://drive.google.com/file/d/1FMqHSZnug-IebvTIhkSwmWhDAPyWxr6A/view?usp=sharing
