...
- MTK7622 2G WiFi(Onboard 2G WiFi) and MTK7615 4x4ac wifi (option 5G WiFi module)
...
TIP: BPi-R64-V12-ASSY

Google Drive: https://drive.google.com/file/d/1_Hie_dmTzkckN4-lVYI3OY7TdflxEj-Q/view?usp=sharing

Baidu  cloud: https://pan.baidu.com/s/162WwU9r-ytf-qccLimETTg?pwd=8888 (pincode: 8888)
...
//=== AArch64 Linux(烧录镜像测试EMMC启动不了，SD卡镜像账号密码登录不进去。所以注销掉该镜像)
