...
In the virtual machine environment, copy the final file out/ISPBOOOT.BIN to a FAT32 or FAT16 USB flash drive,If size of rootfs image is greater 4032 MiB, more than one flash image files will be created. 

```sh
sudo cp ISPBOOOT.BIN /media/your-username/USB-DRIVE/
```
